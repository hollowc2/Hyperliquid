...
| [streak_bot](./streak_bot/) | Freqtrade strategy that detects consecutive same-direction candle streaks and fades them with ATR-based stops, take-profit, and risk-based position sizing. |
